...
FILE_PATH = "D:\MLProjects\sensor-data-pipeline\sample_data\kafka-sensor-topic\aps_failure_training_set1.csv"
...
def produce_data_using_file(topic,file_path):
    ...
    schema= Generic.export_schema_to_create_confluent_schema(file_path)
